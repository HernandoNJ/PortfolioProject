...
namespace Normal
{
	...
	public class PackageManager
	{
		...
		private static void CheckIfPackageExists()
		{
			...
			if (__debugLogging)
				Debug.Log("Normcore Package Manager: Checking if Normcore is installed");
		...
		private static void CheckListRequestProgress()
		{
			...
			if (__listRequest.IsCompleted)
			{
				if (__listRequest.Status == StatusCode.Success)
				{
					...
					if (__debugLogging)
						Debug.Log("Normcore Package Manager: Normcore found: " + normcoreFound);
		...
		private static void CheckAddRequestProgress()
		{
			...
			if (__addRequest.IsCompleted)
			{
				...
				{
					if (__debugLogging)
						Debug.Log("Normcore Package Manager: Success!");
				}
